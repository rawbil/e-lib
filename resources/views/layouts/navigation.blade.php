    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        ...
                        {{-- Simplified: All authenticated users see these links for now --}}
                        <x-nav-link :href="route('my.books')" :active="request()->routeIs('my.books')">
                            {{ __('My Books') }}
                        </x-nav-link>
                        <x-nav-link :href="route('my.fines')" :active="request()->routeIs('my.fines')">
                            {{ __('My Fines') }}
                        </x-nav-link>
                        ...
                        <x-nav-link :href="route('fines.index')" :active="request()->routeIs('fines.index')">
                            {{ __('Fines') }}
                        </x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth {{-- Only show dropdown if user is authenticated --}}
                ...
                @else {{-- Show Login/Register links if user is a guest --}}
                    <a href="{{ route('login') }}"
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                ...
                <x-responsive-nav-link :href="route('my.fines')" :active="request()->routeIs('my.fines')">
                    {{ __('My Fines') }}
                </x-responsive-nav-link>
