<form action="/library-catalogue" class="max-600px:mx-1">
    ...
    <article class=" shadow shadow-dark flex items-center rounded relative ">
        <input type="search" name="search" id="search"
            class="w-full border-none focus:ring-0 focus:outline-none outline-none bg-transparent py-3 placeholder:text-start placeholder:pl-5"
            placeholder="...Search for a book">
        <button type="submit" class="px-2 py-2 absolute left-1">
